...
train %>% count(Sex, Survived) %>% 
  ...
  ggtitle(cat(fig_nums("sex", "Percentual distribution of survivors according to sex")))
...
model %>%
  summary() %$% coefficients %>% 
  kable(caption = cat(table_nums("pclass_sex", "Model estimation")))
...
newdata %>% 
  ...
  ggtitle(cat(fig_nums("pclass_sex", "Interaction between sex and ticket class")))
...
train %>% 
  ...
  ggtitle(cat(fig_nums("age", "Distribution of age according to survived status")))
...
model %>%
  summary() %$% coefficients %>% 
  kable(caption = cat(table_nums("age", "Model estimation")))
...
model %>%
  summary() %$% coefficients %>% 
  kable(caption = cat(table_nums("pclass_age", "Model estimation")))
